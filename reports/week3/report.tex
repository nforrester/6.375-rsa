...
Because of this, we will need to investigate using different chunk sizes to find the most efficient design. We will
run overnight synthesis runs to determine the maximum possible routable block size that will meet timing during
Week 4.
