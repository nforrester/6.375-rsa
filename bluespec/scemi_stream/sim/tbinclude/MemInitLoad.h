...
// DO NOT EDIT
// C++ Class with SceMi Message passing for Bluespec type:  RSAPipelineTypes::MemInitLoad
...
/// C++ class representing the hardware structure RSAPipelineTypes::MemInitLoad
...
class MemInitLoad : public BSVType {
 public:
  ...
  virtual std::ostream & getBSVType (std::ostream & os) const {
    os << "RSAPipelineTypes::MemInitLoad" ;
    return os;
  }
