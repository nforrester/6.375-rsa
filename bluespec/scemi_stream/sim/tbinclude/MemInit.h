...
// DO NOT EDIT
// C++ Class with SceMi Message passing for Bluespec type:  RSAPipelineTypes::MemInit
...
/// C++ class representing the hardware tagged union RSAPipelineTypes::MemInit
...
class MemInit : public BSVType {
 public:
  ...
  MemInit (const SceMiMessageDataInterface *msg, unsigned int &off)
    ...
    the_tag = msg->GetBitRange (off + 32, 0);
    switch (the_tag) {
  ...
  unsigned int setMessageData (SceMiMessageDataInterface &msg, const unsigned int off=0) const {
    msg.SetBitRange(off + 32, 0, the_tag);
    switch (the_tag) {
  ...
  virtual std::ostream & getBitString (std::ostream & os) const {
    ...
    switch (the_tag) {
      case tag_InitLoad:
        ...
        break;
      case tag_InitDone:
        os << std::setw(32) << std::setfill('0') << '0' ;
